...
public abstract class MovableCamera extends JFrame implements GLEventListener {
	...
	protected double x_eye =-48;
	protected double y_eye =-110;
	protected double z_eye = 22;

	protected double x_y_angle = 15;
