...
public class Cadeiras extends AutoDrawnableObject {
	...
	private void desenhaCadeira() {
		...
		gl.glNewList(startList + 3, GL2.GL_COMPILE);
		{
			gl.glBegin(GL2.GL_QUAD_STRIP);
			{
				gl.glTexCoord2f(0, 1);gl.glVertex3f(0, 0, 1);
				...
				gl.glTexCoord2f(1, 0);gl.glVertex3f(0, 0.7f, 1);
				gl.glTexCoord2f(1, 1);gl.glVertex3f(0, 0.7f, 0);
			...
			gl.glBegin(GL2.GL_POLYGON);
			{
				gl.glTexCoord2f(0, 0);gl.glVertex3f(0, 0, 1);
				gl.glTexCoord2f(1, 0);gl.glVertex3f(2, 0, 1);
				gl.glTexCoord2f(0, 1);gl.glVertex3f(2, 0.7f, 1);
				gl.glTexCoord2f(1, 1);gl.glVertex3f(0, 0.7f, 1);
			}
			gl.glEnd();
